...
namespace SweatyBot.Utility
{
    ...
    public class AudioDownloader
    {
        ...
        public AudioDownloader(CustomService customService)
        {
        ...
        public async Task<AudioFile> GetAudioFileInfo(string path)
        {
            ...
            {
                //Doesn't start with http, so search youtube
                this._customService.Log($"Searching youtube for: {path}...", (int)LogType.Text); // Reply in the text channel.
